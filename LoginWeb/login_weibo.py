...
if __name__ == '__main__':
    ...
    # uid = 5895918564 & objectid = & f = 1 & extra = & refer_sort = & refer_flag = 1005050001
    # _ & location = page_100505_home & oid = 5895918564 & wforce = 1 & nogroup = 1 & fnick = % E5 % 92 % 8
    # B % E5 % 95 % A6 % E9 % 98 % BF % E5 % 92 % 8
    # B & refer_lflag = & refer_from = profile_headerv6 & template = 7 & special_focus = 1 & isrecommend = 1 & is_special = 0 & redirect_url = % 252
    # Fp % 252
    # F1005055156567902 % 252
    # Fmyfollow % 253
    # Fgid % 253
    # D3715151159472880 % 2523
    # place & _t = 0
    data_follow={
        'uid': ,
        # 'uid': '5895918564',
        # 'fnick': '咋啦阿咋',
        # 'redirect_url': '%2Fp%2F1005055156567902%2Fmyfollow%3Fgid%3D3715151159472880%23place',
        # 'refer_from': 'refer_from	profile_headerv6',
        # 'f': '1',
    ...
    print(session.post('https://d.weibo.com/aj/f/followed?ajwvr=6&__rnd=1548141518228',data=data_follow, verify=False))
